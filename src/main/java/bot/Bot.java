...
public class Bot extends TelegramLongPollingBot {
    ...
    List<MessageHandler> handlers = List.of(
            ...
            new SettingDaysMessageHandler(), new SelectionDayMessageHandler(), new SelectingTimeMessageHandler(), new TimingMessageHandler(), new TaskListMessageHandler(), new LinkMessageHandler(), new ProjectMessageHandler(), new MyProjectMessageHandler(), new TagSettingsMessageHandler(),
            new TasksMessageHandler(), new TaskListMessageHandler(), new TagsMessageHandler(), new AddTagToTaskHandler(),
            new ReturnTagMessageHandler()
    );
